...
# Print the current selection of bags and meals and
...
# Implementation of second selection menu,
# in a while loop to make sure all entered numbers are valid.
# There are also checks to make sure bags or meals can't be higher
# than the allowed value or go to negative values.
